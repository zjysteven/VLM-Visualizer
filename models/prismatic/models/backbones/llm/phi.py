...
class PhiLLMBackbone(HFCausalLLMBackbone):
    def __init__(
        ...
        self._half_precision_dtype = torch.bfloat16
    ...
    @half_precision_dtype.setter
    def half_precision_dtype(self, dtype: torch.dtype) -> None:
        self._half_precision_dtype = dtype
